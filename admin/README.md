...
1. [setup starter script](/templates/README.md#install-bluesky-starter-scripts)
1. [`spec2ophyd`: translate SPEC config file](https://apstools.readthedocs.io/en/latest/applications/spec2ophyd.html)
